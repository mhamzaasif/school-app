...
export const RootContext = ({ children }) => {
    const [userState, userDispatch] = useReducer(userReducer, userRedcuerinitialState);
    const [themeState, themeDispatch] = useReducer(themeReducer, themeRedcuerinitialState);
